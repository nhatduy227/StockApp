  ...
  <div>
    ...
    <div>
      <Container>
        ...
        <br></br>
        <Row >
          <Col sm><div class="p-3 mb-2 bg-green text-dark">Get started on your investing journey!</div></Col>
          <Col sm><div class="p-3 mb-2 bg-green text-dark">Browse and track various stocks!</div></Col>
          <Col sm><div class="p-3 mb-2 bg-green text-dark">Build up your stock portfolio!</div></Col>
        </Row>
        <br></br>
